#!/usr/bin/env python3
"""Helper script to create knowledge_engine.py"""
...
def main():
    ...
    print(f"✅ Generated {mock_data['metadata']['totalDecisions']} decisions")
    print(f"✅ Generated {mock_data['metadata']['totalLandmines']} landmines")
    print(f"✅ Generated {mock_data['metadata']['totalPersons']} persons")
    print(f"✅ Generated {mock_data['metadata']['totalFiles']} files")
    print(f"✅ Generated {len(mock_data['relationships'])} relationships")
...
with open('knowledge_engine.py', 'w', encoding='utf-8') as f:
    f.write(content)

print("✅ knowledge_engine.py created successfully!")
